...
function getDb() {
  ...
  try {
    ...
    // Este log queda en los logs de Vercel (Project -> Deployments -> Functions),
    // nunca llega al usuario. Ayuda a diagnosticar rápido si la ruta del
    // archivo .db es incorrecta o el archivo no se subió al repo.
    console.error(`[database] No se pudo abrir la base en ${DB_PATH}:`, err.message);
    throw err;
  }
